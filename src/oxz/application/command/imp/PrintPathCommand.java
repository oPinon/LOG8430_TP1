...
/**
 * The PrintPathCommand can execute on folder or a file Call setFile to set the
 * target file (Receiver in Command Pattern) Call execute() method if the file
 * is set. The result will set the command result to its resultString attribute
 */
