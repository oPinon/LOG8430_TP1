...
4. If you want pass the tests, right click the oxz.application.test package, then choose “Run As” -> “JUnit test”.

How to use this application:

1. This application let you to execute commands on a file of folder, the default file is the folder of this project.

2. The left side of application allow you to choose a file. Click the folder image to open/close a folder. Click it name button to set it as the target of commands.
...
4. Once the target file is selected, the executable command can be execute at the right side of this application. Click the command and the result will be shown in the right side of the command button
